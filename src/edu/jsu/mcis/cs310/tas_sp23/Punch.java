...
public class Punch {
    ...
    /**
     * <p> This method rounds the employee's start or end time to fit their
     * schedule. It also rounds their lunch start and end times to fit their 
     * schedule. It calculates the type of adjustment and the adjusted time
     * stamps. </p>
     * @param s 
     */
