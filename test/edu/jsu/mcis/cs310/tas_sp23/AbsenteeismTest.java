...
public class AbsenteeismTest {
    ...
    public void test4(){
        ...
        /* Compare to Expected Value */
        assertEquals("#ADD650A8 (Pay Period Starting 08-05-2018): 80.00%", a2.toString());
    }
    ...
    public void test5(){
        ...
        /* Compare to Expected Value */
        assertEquals("#398B1563 (Pay Period Starting 08-05-2018): 3.75%", a2.toString());
    }
